# ============================================================================
# File: networks.py
# Description: Neural network architectures for Actor and Individual Q-networks (SAC)
# ============================================================================
"""
Neural Network Architectures for SAC (Soft Actor-Critic)

This module defines:
- ActorNetwork: Decentralized policy π_i(a_i | s_i; θ_i)
- IndividualQNetwork: Individual Q-function Q_i(s_i, a_i; ω_i) for SAC
...
class IndividualQNetwork(nn.Module):
    ...
    In SAC, each agent uses soft Q-learning with entropy regularization:
