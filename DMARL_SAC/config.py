# ============================================================================
# File: config.py
# Description: Configuration and hyperparameters for SAC
# ============================================================================
"""
Configuration module for SAC on Wireless Communication Environment
...
class Config:
    """
    Hyperparameters for SAC algorithm
    ...
    # ====================
    alpha: float = 0.2  # Temperature parameter for entropy regularization
    use_automatic_entropy_tuning: bool = False  # Automatically tune temperature
    target_entropy_coef: float = 0.98  # Target entropy coefficient (for auto-tuning)
    lr_alpha: float = 3e-4  # Learning rate for temperature (if auto-tuning)
    ...
    def __repr__(self) -> str:
        return (
            f"Config(\n"
            f"  Algorithm: SAC (Soft Actor-Critic)\n"
