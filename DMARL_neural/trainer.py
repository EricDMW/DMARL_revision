# ============================================================================
# File: trainer.py
# Description: Training loop and utilities
# ============================================================================
"""
Training Module for DMARL
...
class Trainer:
    """
    Trainer class for DMARL on Wireless Communication Environment
    ...
    def _extract_local_obs(self, info: Dict, obs: Optional[np.ndarray] = None) -> Tuple[List[np.ndarray], np.ndarray]:
        ...
        if 'local_obs' in info:
            ...
            # We need to create full observations (this shouldn't happen if obs is available)
            ...
            if training:
                ...
                if (self.system.total_steps > self.config.warmup_steps and
                    ...
                    if result is not None:
                        critic_losses, actor_losses = result
    ...
    def train(self) -> Dict:
        ...
        """
        print("=" * 60)
        print("Starting DMARL Training for Wireless Communication")
        print("=" * 60)
        print(self.config)
        print("=" * 60)
    ...
    def _log_progress(self, episode: int, start_time: float) -> None:
        ...
        tqdm.write(f"  Critic Loss:        {avg_critic_loss:.4f}")
