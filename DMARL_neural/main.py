...
# ============================================================================
"""
Main Entry Point for DMARL on Wireless Communication
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='DMARL for Wireless Communication Environment'
    )
...
def main():
    ...
    print("\n" + "=" * 60)
    print("DMARL for Wireless Communication Environment")
    print("=" * 60)
