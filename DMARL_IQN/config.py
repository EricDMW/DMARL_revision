# ============================================================================
# File: config.py
# Description: Configuration and hyperparameters for IQN
# ============================================================================
"""
Configuration module for IQN on Wireless Communication Environment
...
class Config:
    """
    Hyperparameters for IQN algorithm
    ...
    def __repr__(self) -> str:
        return (
            f"Config(\n"
            f"  Algorithm: IQN (Independent Q-Network)\n"
