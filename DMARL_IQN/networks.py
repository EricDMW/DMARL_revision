# ============================================================================
# File: networks.py
# Description: Neural network architectures for Actor and Individual Q-networks (IQN)
# ============================================================================
"""
Neural Network Architectures for IQN (Independent Q-Network)

This module defines:
- ActorNetwork: Decentralized policy π_i(a_i | s_i; θ_i)
- IndividualQNetwork: Individual Q-function Q_i(s_i, a_i; ω_i) for IQN
